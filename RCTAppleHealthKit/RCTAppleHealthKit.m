...
RCT_EXPORT_METHOD(getDailyDietarySamples:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
{
    [self nutrition_getDailyDietarySamples:input callback:callback];
}
